export default async function fetchMovies(data) {
  ...
  const options = {
    ...
    headers: {
      ...
      Authorization:
        "Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiIyZDRiNzYzNjZhOTc0ZTkwY2MwYzA3OWI5MTRjYTViMiIsIm5iZiI6MTczMzA2MTIyNi45MDUsInN1YiI6IjY3NGM2YTZhMGQ5OWI0NDM2MWUwMjQxNyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.q6IkzeQZRHR4haJ0Kp7U4o97if53jVH7-aVDsF0Jykk",
    },
  };
  try {
